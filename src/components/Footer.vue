<template>
  <footer class="bg-stone-900 text-stone-300 py-12 border-t-4 border-glamour-gold">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col items-center md:items-start space-y-4">
          <a href="#" class="text-2xl font-serif font-bold text-white flex items-center gap-2">
            ...
            <div class="flex flex-col leading-none">
              ...
              <span class="text-xs font-sans tracking-[0.2em] font-light uppercase text-stone-400">Glamour Store</span>
            </div>
          </a>
          <p class="text-sm font-light leading-relaxed max-w-xs text-stone-400">
            Realce sua beleza natural com produtos selecionados especialmente para o seu bem-estar e autocuidado diário.
          </p>
        </div>
      ...
      <div class="mt-12 pt-8 border-t border-stone-800 text-center text-xs text-stone-500 flex flex-col items-center">
        <p>&copy; {{ new Date().getFullYear() }} SM Glamour Store. Todos os direitos reservados.</p>
        <p class="mt-2 text-[10px] uppercase font-bold tracking-widest text-glamour-gold">Feito por <a href="https://github.com/deivid01" target="_blank" class="text-white hover:text-glamour-primary transition-colors">Deivid Peres</a></p>
      </div>
    </div>
  </footer>
</template>
